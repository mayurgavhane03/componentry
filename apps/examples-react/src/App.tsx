...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <section style={{ marginBottom: "2rem" }}>
    <h2 style={{ fontSize: "0.8rem", textTransform: "uppercase", letterSpacing: "0.05em", color: "#888", marginBottom: "0.75rem" }}>
      {title}
    </h2>
    {children}
  </section>
  ...
  return (
    <main style={{ padding: "2rem", fontFamily: "sans-serif" }}>
      ...
      <Section title="4. Pill">
        <Row>
          <CButton variant="primary" pill>Primary Pill</CButton>
          <CButton variant="success" pill outline>Outline Pill</CButton>
          <CButton variant="danger" pill size="small">Small Pill</CButton>
          <CButton variant="neutral" pill size="large">Large Pill</CButton>
        </Row>
      </Section>
      ...
      <Section title="5. Circle (icon buttons)">
        <Row>
          <CButton circle variant="default">✕</CButton>
          <CButton circle variant="primary">★</CButton>
          <CButton circle variant="danger" size="small">🗑</CButton>
          <CButton circle variant="success" size="large">✓</CButton>
          <CButton circle variant="neutral" outline>⚙</CButton>
        </Row>
      </Section>
      ...
      <Section title="6. Caret">
        <Row>
          ...
          <CButton variant="primary" caret>Primary + Caret</CButton>
          <CButton variant="neutral" caret outline>Outline + Caret</CButton>
          <CButton variant="warning" caret pill>Pill + Caret</CButton>
        </Row>
      </Section>
      ...
      <Section title="7. Loading">
        <Row>
          ...
          <CButton loading variant="primary">Primary</CButton>
          <CButton loading variant="danger" outline>Outline</CButton>
          <CButton loading variant="success" pill>Pill</CButton>
          <CButton loading circle variant="neutral">★</CButton>
        </Row>
      </Section>
      ...
      <Section title="8. Disabled">
        <Row>
          ...
          <CButton disabled variant="primary">Primary</CButton>
          <CButton disabled variant="success" outline>Outline</CButton>
          <CButton disabled variant="danger" pill>Pill</CButton>
          <CButton disabled circle>✕</CButton>
        </Row>
      </Section>
      ...
      <Section title="13. Form types">
        <Row>
          <form onSubmit={(e) => { e.preventDefault(); setClickLog("Form submitted!"); }}
          ...
          <form style={{ display: "flex", gap: "0.5rem", alignItems: "center" }}>
            <input type="text" defaultValue="clear me" style={{ padding: "0.25rem 0.5rem" }} />
      ...
      <Section title="14. Tooltip">
        <Row>
          ...
          <CButton tooltip="Permanently deletes the record" variant="danger" circle>🗑</CButton>
        </Row>
      </Section>
      ...
      <Section title="16. onClick — update state (click counter)">
        <Row>
          <CButton variant="neutral" onClick={() => setClickCount((c) => c + 1)}>
            Clicked {clickCount} time{clickCount !== 1 ? "s" : ""}
          </CButton>
          <CButton variant="text" onClick={() => setClickCount(0)}>Reset</CButton>
        </Row>
      </Section>
      ...
      <Section title="17. onClick — toggle variant (like button)">
        <Row>
          <CButton variant={liked ? "success" : "default"} onClick={() => setLiked((l) => !l)}>
            {liked ? "❤️ Liked" : "🤍 Like"}
          </CButton>
        </Row>
      </Section>
      ...
      <Section title="18. onClick — async action with loading state">
        <Row>
          ...
          {isDone && (
            <CButton variant="text" onClick={() => setIsDone(false)}>Reset</CButton>
          )}
        </Row>
      </Section>
      ...
      <Section title="20. disabled — onClick does not fire">
        <Row>
          <CButton variant="primary" disabled onClick={() => alert("Should not fire")}>
            Disabled (no-op)
          </CButton>
        </Row>
      </Section>
      ...
      <Section title="21. loading — onClick is also suppressed">
        <Row>
          <CButton variant="primary" loading onClick={() => alert("Should not fire")}>
            Loading (no-op)
          </CButton>
        </Row>
      </Section>
      ...
      <Section title="23. onClick — conditionally swap variant">
        <Row>
          <CButton variant={danger ? "danger" : "warning"} onClick={() => setDanger((d) => !d)}>
      ...
      <Section title="26. Imperative methods via ref">
        <Row>
          ...
          <CButton variant="neutral" onClick={() => (focusTargetRef.current as any)?.setFocus()}>
            setFocus()
          </CButton>
          <CButton variant="neutral" onClick={() => (focusTargetRef.current as any)?.removeFocus()}>
            removeFocus()
          </CButton>
          <CButton variant="neutral" onClick={() => (focusTargetRef.current as any)?.triggerClick()}>
            triggerClick()
          </CButton>
          <span style={{ fontSize: "0.85rem", color: "#555" }}>{eventLog}</span>
        </Row>
      ...
      <Section title="27. Combined combos">
        <Row>
          <CButton
            variant="primary" pill caret size="large"
          ...
          <CButton
            variant="success" circle size="large"

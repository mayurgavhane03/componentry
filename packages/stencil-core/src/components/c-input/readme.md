...
| ----------------------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | ----------- |
| `autocapitalize` _(required)_ | `autocapitalize`  |                                                                                                                              | `"characters" \| "none" \| "off" \| "on" \| "sentences" \| "words"`                                                 | `undefined` |
| `autocomplete` _(required)_   | `autocomplete`    |                                                                                                                              | `string`                                                                                                            | `undefined` |
| `autocorrect` _(required)_    | `autocorrect`     |                                                                                                                              | `"off" \| "on"`                                                                                                     | `undefined` |
| `autofocus` _(required)_      | `autofocus`       |                                                                                                                              | `boolean`                                                                                                           | `undefined` |
| `clearable`                   | `clearable`       | Adds a clear button when the input is not empty.                                                                             | `boolean`                                                                                                           | `false`     |
| `disabled`                    | `disabled`        | Disables the input.                                                                                                          | `boolean`                                                                                                           | `false`     |
| `enterkeyhint` _(required)_   | `enterkeyhint`    |                                                                                                                              | `"done" \| "enter" \| "go" \| "next" \| "previous" \| "search" \| "send"`                                           | `undefined` |
...
| `inputmode` _(required)_      | `inputmode`       |                                                                                                                              | `"decimal" \| "email" \| "none" \| "numeric" \| "search" \| "tel" \| "text" \| "url"`                               | `undefined` |
